...
<head>
    ...
    <style>
        ...
        #hospital-info, #experience, #location {
            margin-top: 20px;
        }
...
<body>
    ...
    <div id="profile">
        <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSZeEzeqSeG5MwgQd6_tq3q66w-XrYcZ8lZZA&usqp=CAU" alt="Dr. Anitha">
        <div id="details">
            ...
            <div id="experience">
                <h2>Experience</h2>
                <p>Dr. Anitha has over 15 years of experience in the field of cardiology. She specializes in diagnosing and treating various heart conditions.</p>
            </div>
